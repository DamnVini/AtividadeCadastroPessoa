public class Main {
			...
			System.out.println("O nome da pessoa1 é " + pessoa2.getNome() + ", ela tem " + pessoa2.getIdade() + " anos e é do sexo: " + pessoa2.getSexo() + ". " + "Ela mora no bairro: " + endereco2.getBairro() + ", na rua: " + endereco2.getRua() + " N#" + endereco2.getNumero());
			System.out.println("O nome da pessoa1 é " + pessoa3.getNome() + ", ela tem " + pessoa3.getIdade() + " anos e é do sexo: " + pessoa3.getSexo() + ". " + "Ela mora no bairro: " + endereco3.getBairro() + ", na rua: " + endereco3.getRua() + " N#" + endereco3.getNumero());
			}	
	}
